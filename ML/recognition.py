import cv2
import numpy as np
from ML.neural_network import load_model, forward  # NEA model, not TensorFlow
...
tomorrow:
- Make it do pictures instead of video
- See if shapes are being stretched as they are made to fit 28,28
'''
